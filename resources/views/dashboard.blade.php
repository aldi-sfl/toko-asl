...
<div class="content">
   ...
   <div class="kategori">
    ...
    @endforeach
      {{-- <a href="#" class="category-items">
      <div class="card" style="width: 18rem;">
         <img src="img/logo/keyboard.png" class="card-img-top" alt="...">
         <div class="card-body">
           <p class="card-text text-center">Keyboard</p>
         </div>
       </div>
      </a>
         ...
         <div class="card">
            ...
            <div class="card-info">
              <a href="" style="text-decoration: none"> 
                <p class="text-title">{{ $item->nama_produk }} </p>
                 </a>
              <p class="text-body">{{ $item->deskripsi }}</p>
            </div>
            <div class="card-footer">
            <span class="text-title">Rp {{ number_format($item->harga, 0, ',', '.') }}</span>
